...
export default function Home() {
  return <div className="min-h-screen bg-white">
    ...
    <footer className="border-t px-5 py-6 text-center text-sm text-slate-500"><p>PIKAS · Experiencia de demostración. No procesa dinero real.</p><p className="mt-2 font-semibold text-slate-600">Diseñada y desarrollada por Palmchat Innovations LLC.</p><Link className="mt-2 inline-flex font-bold text-slate-600 underline" href="/admin/login">Acceso administrativo</Link></footer>
  </div>;
}
