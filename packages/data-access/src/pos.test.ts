...
const student: PosStudentRecord = {id:"sofia",preferredName:"Sofi",grade:"5.º A",code:"PK-10982",school:"Instituto Nueva Generación",status:"active",walletStatus:"active",balanceMinor:245000,dailyLimitMinor:35000,perTransactionLimitMinor:25000,spentTodayMinor:16000,allergies:["Maní","Lactosa"],blockedProducts:["Bebidas energéticas"]};
const menu: PosMenuItemRecord[] = [
  {id:"pasta",name:"Pasta con pollo",description:"",category:"Almuerzo",priceMinor:18000,allergens:[],available:true},
  {id:"pizza",name:"Pizza escolar",description:"",category:"Almuerzo",priceMinor:15000,allergens:["Lactosa"],available:true},
  {id:"energy",name:"Bebidas energéticas",description:"",category:"Bebidas",priceMinor:11000,allergens:[],available:true},
  {id:"closed",name:"Especial del día",description:"",category:"Almuerzo",priceMinor:10000,allergens:[],available:false},
];
